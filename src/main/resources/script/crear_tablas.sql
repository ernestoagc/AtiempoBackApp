...
INSERT INTO VALOR (LISTA,CODIGO,VALOR) VALUES((SELECT ID FROM LISTA WHERE CODIGO='ESTADO_VIAJE'),'PENDIENTE','Pendiente');
INSERT INTO VALOR (LISTA,CODIGO,VALOR) VALUES((SELECT ID FROM LISTA WHERE CODIGO='ESTADO_VIAJE'),'PROGRESO','En Progreso');
INSERT INTO VALOR (LISTA,CODIGO,VALOR) VALUES((SELECT ID FROM LISTA WHERE CODIGO='ESTADO_VIAJE'),'TERMINADO','Terminado');
...
references VALOR (ID);
 ...
 alter table RESERVA
add constraint fkReservaPasajero
