...
// hibernate 3import org.hibernate.engine.SessionImplementor;
import org.hibernate.engine.spi.SessionImplementor;
import org.hibernate.internal.CriteriaImpl;
// hibernate 3 import org.hibernate.impl.CriteriaImpl;
//hibernate 4
...
public class Busqueda implements CriteriaSpecification, Serializable {
	...
	public Busqueda createCriteria(String associationPath, int joinType)
			throws HibernateException {
		return new Busqueda(impl, criteria.createCriteria(associationPath,
				joinType));
	}
